...
public class Device_List extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent i = getIntent();
        userInfo = (UserInfo) i.getSerializableExtra("userinfo");
        final String name=userInfo.getname();
        //Log.d("DEVICELIST","again "+userInfo.getPass());
        textView=(TextView)findViewById(R.id.textView);
        textView.setText("Select Your Home "+name);
        //Calling widgets
    ...
    private AdapterView.OnItemClickListener myListClickListener = new AdapterView.OnItemClickListener() {
        public void onItemClick(AdapterView<?> av, View v, int arg2, long arg3) {
            ...
            Intent i = new Intent(Device_List.this, Control_Page.class);
